...
// currently running. Returns an if the node is not valid (i.e., the
// underlying service is not deployed on the node passed).
...
// Finalizing returns whether the system is known to be
...
// "default" service in the test. If a virtua cluster was created, it
