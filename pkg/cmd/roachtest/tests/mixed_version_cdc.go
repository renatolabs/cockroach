...
// goal is to ensure that database by the validator does not happen
// while we are running an upgrade. We used to retry database calls in
// the validator, but that logic adds complexity and does not help in
// testing the changefeed's correctness
